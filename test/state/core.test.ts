...
describe("state/core", () => {
  ...
  test("listen to change", () => {
    ...
    x.set(1);
    x.set(2);
    x.set(2); // supposedly wont trigger because no change
  ...
  test("stop listening to change", () => {
    ...
    x.set(1); // ensure it was triggered at least once
    unsub();
    x.set(2);
    x.set(3);
